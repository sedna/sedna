...
cmake "$CMAKE_G" -DENHANCE_TERM=$ENHANCE_TERM -DEL_DEBUG=$EL_DEBUG -DCMAKE_BUILD_TYPE=$CMAKE_BUILD_TYPE -DMAKE_DOC=$MAKE_DOC -DJAVA_DRIVER=$JAVA_DRIVER $SEDNA_SOURCE_DIR
CMAKE_RET=$?
popd  > /dev/null 2>&1
