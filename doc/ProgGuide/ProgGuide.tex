...
\end{verbatim}
\begin{verbatim}
[linux:] INSTALL_DIR/examples/api/java/Client.java
\end{verbatim}
...
\end{verbatim}
\begin{verbatim}
[linux:] INSTALL_DIR/examples/api/c/Client.c
\end{verbatim}
...
[linux:] INSTALL_DIR/examples/api/scheme
\end{verbatim}
where \verb!INSTALL_DIR! refers to the directory where Sedna is installed.
...
\end{verbatim}
\begin{verbatim}
[linux:] INSTALL_DIR/examples/api/external-functions/c/
\end{verbatim}
where \verb!INSTALL_DIR! refers to the directory where Sedna is installed.
