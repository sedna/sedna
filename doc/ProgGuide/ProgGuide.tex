...
using the XQuery index-scan functions specified in Section \ref{sec:index-scan-fun}.
\end{note}
...
The value of the \verb!name! attribute is the name of the document or collection. If the \verb!WITH! \verb!STATISTICS! command is stated, the following statistical information is retrieved as the content of the \verb!Document! or \verb!Collection! elements:
