...
You can retrieve various metadata about database objects (such as documents, collections, indices, etc.) as XML data by querying the following predefined documents:
\begin{itemize}
\item \verb!$catalog.xml! - list of all stand-alone documents and collections
\item \verb!$documents.xml! - list of all stand-alone documents and in-collection documents
\item \verb!$indexes.xml! - list of indecies with information about them 
\item \verb!$ftindexes.xml! - list of full-text indecies with information about them (if compiled with \verb!SE_ENABLE_FTSEARCH!)
\item \verb!$schema.xml! - descriptive schema of all documents and collections with some schema-related  information 
\item \verb!$collections.xml! - list of all collections
\item \verb!$errors.xml! - list of all user errors
\item \verb!$version.xml! - version and build numbers
\item \verb!$document_<name>! - statistical information about the document named <name>
\item \verb!$schema_<name>! - the descriptive schema of the document named <name>
\end{itemize}


The statistical information in the document \verb!$document_<name>! contains the following elements:
...
In addition to trace facility provided by standard XQuery fn:trace function (see section above) you can turn on session debug mode. For details on turning debug mode on see "Sedna Terminal" section of the Sedna's Administration Guide. 
