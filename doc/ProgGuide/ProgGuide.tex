...
You can find the result of running the XML Query Test Suite (i.e. W3C official test suite for XQuery) on Sedna at \verb!http://www.w3.org/XML/Query/test-suite/XQTSReport.html!
