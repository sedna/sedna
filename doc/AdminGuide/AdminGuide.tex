...
would listen to localhost. Note that in Sedna versions less than 3.5 Governor
operated in the other way: it listen to every interface in the system; since version
3.5 it doesn't due to security reasons. If you want to make Governor work in the
old-fashioned way you should set \verb!-listen-address! option to \verb!0.0.0.0! ---
that would force Sedna to listen every interface in your system as it worked in
older versions.
...
%===============================================================================
%                  Sedna Administation Guide: References
%===============================================================================
