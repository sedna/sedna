...
Below \verb!SEDNA_INSTALL! refers to the directory where Sedna is installed. The directory structures are identical on all supported platforms.
...
%                                    database-specific libraries of external
%                                    functions
%SHARE_PREFIX/sedna-x.x.x/examples   command line and Sedna API examples
