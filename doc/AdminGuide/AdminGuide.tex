...
Below \verb!SEDNA_INSTALL! refers to the directory where Sedna is installed.
The directory structures are identical on all supported platforms.
...
%\begin{verbatim}
%REVOKE "role-name"
%FROM "user-name" [, "user-name"] | PUBLIC
%\end{verbatim}
