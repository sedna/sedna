...
//printf("load LAYER_ADDRESS_SPACE_SIZE = %d\n", LAYER_ADDRESS_SPACE_SIZE);
...
//printf("create LAYER_ADDRESS_SPACE_START_ADDR_INT = 0x%x\n", v.LAYER_ADDRESS_SPACE_START_ADDR_INT);
//printf("create LAYER_ADDRESS_SPACE_BOUNDARY_INT = 0x%x\n", v.LAYER_ADDRESS_SPACE_BOUNDARY_INT);
//printf("create PH_ADDRESS_SPACE_START_ADDR_INT = 0x%x\n", v.PH_ADDRESS_SPACE_START_ADDR_INT);
//printf("create LAYER_ADDRESS_SPACE_SIZE = 0x%x\n", v.LAYER_ADDRESS_SPACE_SIZE);
