...
forClauseInt:
    ...
    |   varRef positionalVar _IN exprSingle
        {
            ASTTypeVar *tv = new ASTTypeVar(@1, new ASTTypeSeq(@1, new ASTType(@1, new std::string("!xs:anyType"), ASTType::ABSTRACT), ASTTypeSeq::NONE), static_cast<ASTVar *>($1));
...
quantifiedExprVarList:
    ...
    |   varRef _IN exprSingle
        {
            $$ = new ASTNodesVector();
            $$->push_back(new ASTTypeVar(@$, new ASTTypeSeq(@1, new ASTType(@1, new std::string("!xs:anyType"), ASTType::ABSTRACT), ASTTypeSeq::NONE), static_cast<ASTVar *>($1)));
            $$->push_back($3);
        }
    ...
    |   quantifiedExprVarList COMMA varRef _IN exprSingle
        {
            $1->push_back(new ASTTypeVar(@$, new ASTTypeSeq(@1, new ASTType(@1, new std::string("!xs:anyType"), ASTType::ABSTRACT), ASTTypeSeq::NONE), static_cast<ASTVar *>($3)));
            $1->push_back($5);
            $$ = $1;
        }
