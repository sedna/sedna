...
localPart1!: <<ANTLRTokenPtr tk = (ANTLRTokenPtr)LT(1);>>
	...
	| CTYPE   <<#0=#["type", AST_LOCAL_NAME, tk->getLine()];>>
...
prefixPart4!: <<ANTLRTokenPtr tk = (ANTLRTokenPtr)LT(1);>>
	CREATE_LOWCASE <<#0=#["create", AST_PREFIX, tk->getLine()];>>
	| DROP_LOWCASE <<#0=#["drop", AST_PREFIX, tk->getLine()];>>
	| RENAME_LOWCASE <<#0=#["rename", AST_PREFIX, tk->getLine()];>>
    | INTO_LOWCASE <<#0=#["into", AST_PREFIX, tk->getLine()];>>
	| GRANT_LOWCASE <<#0=#["grant", AST_PREFIX, tk->getLine()];>>
	| REVOKE_LOWCASE <<#0=#["revoke", AST_PREFIX, tk->getLine()];>>
	| LOADFILE_LOWCASE <<#0=#["loadfile", AST_PREFIX, tk->getLine()];>>
	| LOAD_LOWCASE <<#0=#["load", AST_PREFIX, tk->getLine()];>>
	| ALTER_LOWCASE <<#0=#["alter", AST_PREFIX, tk->getLine()];>>
	| ROLE_LOWCASE <<#0=#["role", AST_PREFIX, tk->getLine()];>>
	| DATABASE_LOWCASE <<#0=#["database", AST_PREFIX, tk->getLine()];>>
	| INDEX_LOWCASE <<#0=#["index", AST_PREFIX, tk->getLine()];>>
	| FULLTEXT_LOWCASE <<#0=#["full-text", AST_PREFIX, tk->getLine()];>>
	| FROM_LOWCASE <<#0=#["from", AST_PREFIX, tk->getLine()];>>
	| STDIN_LOWCASE <<#0=#["stdin", AST_PREFIX, tk->getLine()];>>
	| USER_LOWCASE <<#0=#["user", AST_PREFIX, tk->getLine()];>>
	| PASSWORD_LOWCASE <<#0=#["password", AST_PREFIX, tk->getLine()];>>
	| ALL_LOWCASE <<#0=#["all", AST_PREFIX, tk->getLine()];>>
	| PUBLIC_LOWCASE <<#0=#["public", AST_PREFIX, tk->getLine()];>>
	| TRIGGER_LOWCASE <<#0=#["trigger", AST_PREFIX, tk->getLine()];>>
	| BEFORE_LOWCASE <<#0=#["before", AST_PREFIX, tk->getLine()];>>
	| AFTER_LOWCASE <<#0=#["after", AST_PREFIX, tk->getLine()];>>
	| CINSERT_LOWCASE <<#0=#["insert", AST_PREFIX, tk->getLine()];>>
	| CDELETE_LOWCASE <<#0=#["delete", AST_PREFIX, tk->getLine()];>>
	| CREPLACE_LOWCASE <<#0=#["replace", AST_PREFIX, tk->getLine()];>>
	| EACH_LOWCASE <<#0=#["each", AST_PREFIX, tk->getLine()];>>
	| STATEMENT_LOWCASE <<#0=#["statement", AST_PREFIX, tk->getLine()];>> 
	| CDO_LOWCASE <<#0=#["do", AST_PREFIX, tk->getLine()];>>
	| RETRIEVE_LOWCASE <<#0=#["retrieve", AST_PREFIX, tk->getLine()];>>
	| METADATA_LOWCASE <<#0=#["metadata", AST_PREFIX, tk->getLine()];>>
	| DOCUMENTS_LOWCASE <<#0=#["documents", AST_PREFIX, tk->getLine()];>>
	| COLLECTIONS_LOWCASE <<#0=#["collections", AST_PREFIX, tk->getLine()];>>
	| CCOLLECTION_LOWCASE <<#0=#["collection", AST_PREFIX, tk->getLine()];>>
