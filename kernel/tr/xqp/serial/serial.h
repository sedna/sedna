...
#ifndef _INT_VISITOR_H_
#define _INT_VISITOR_H_

#include "tr/xqp/visitor/ASTVisitor.h"
#include <string>

class IntVisitor : public ASTVisitor
{
private:
    std::string int_str;
...
public:
    IntVisitor(sedna::XQueryDriver *drv_, sedna::XQueryModule *mod_) : ASTVisitor(drv_, mod_)
    {
        resetVisitor();
    }
