 ...
 */
    ...
    virtual se_ostream& writextext(const char *s, int n); // depricated
    virtual se_ostream& writeattribute(const char *s, int n); // depricated

//    virtual se_ostream& flush_stm();
