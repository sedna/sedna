...
#include "tr/executor/PPOperations.h"
...
public:
    ...
    /* Aggregate functions */
    virtual void visit(PPAggrFuncContainer& op)        = 0;
    ...
    virtual void visit(PPTrace& op)                    = 0;
    ...
    virtual void visit(PPExplain& op)                  = 0;
    ...
    virtual void visit(fun_conv_rules& fcr)            = 0;
    ...
    /* SQL connection */
    virtual void visit(PPFnSQLBase& op)                = 0;
