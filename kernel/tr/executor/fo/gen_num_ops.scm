...
(define (out-XMLSchema-type-as-C-type type)
  (let* ((type-str (symbol->string type))
    ...
    (out (if (string=? str "integer") "int" str))))
    ...
    (cond ((string=? word "integer_divide")
           (if
            ...
            (begin
              ...
              (nl)
              (out
               "    if (is_zero(a2_val)) throw USER_EXCEPTION2(FOAR0001, \"Division by zero in op:numeric-integer-divide\");")
              (nl)
          ...
          ((string=? word "divide")
           (begin
             (out "    ")
             (if (eq? gct 'xs_integer) (out "decimal") (out-XMLSchema-type-as-C-type gct))
             (out " a2_val = ")
             (if (eq? gct 'xs_integer) (out "xs_integer2xs_decimal(a2)") (generate-arg word type2 gct "a2"))
             (out ";")
             (nl)
             (out
              "    if (is_zero(a2_val)) throw USER_EXCEPTION2(FOAR0001, \"Division by zero in op:numeric-divide\");")
             (nl)
             (out "    return tuple_cell::atomic(")
             (if (eq? gct 'xs_integer) (out "xs_integer2xs_decimal(a1)") (generate-arg word type1 gct "a1"))
             (out " ")
             (out symb)
             (out " a2_val);")))
          ((string=? word "mod")
           (begin
             ...
             (nl)
             (out
              "    if (is_zero(a2_val)) throw USER_EXCEPTION2(FOAR0001, \"Division by zero in op:numeric-mod\");")
             (nl)
             (out "    return tuple_cell::atomic(")
             (out symb)
             (out "(")
...
(nl)
(nl)
(generate-numeric-funs generate-numeric-fun-prototype op-lst type-lst)
(nl)
(nl)
(generate-numeric-funs generate-numeric-fun-e-prototype op-lst type-lst)
(nl)
(nl)
(out "tuple_cell op_numeric_unary_plus(const tuple_cell &a);")(nl)
(out "tuple_cell op_numeric_unary_minus(const tuple_cell &a);")(nl)
(nl)
(nl)
(out "tuple_cell op_numeric_unary_plus_e(const tuple_cell &a);")(nl)
(out "tuple_cell op_numeric_unary_minus_e(const tuple_cell &a);")(nl)
(nl)
(nl)
...
(out "tuple_cell op_numeric_unary_plus_xdt_untypedAtomic(const tuple_cell& a);")(nl)
(nl)
...
(out "tuple_cell op_numeric_unary_minus_xdt_untypedAtomic(const tuple_cell& a);")(nl)
(nl)
(out "#endif")
(nl)
...
(out "#include \"PPUtils.h\"")(nl)
(nl)
(out "inline int fmod(int a1, int a2) { return a1 % a2; }")(nl)
;(out "inline float fmod(float a1, float a2) { return fmodf(a1, a2); }")(nl)
(out "#ifdef _WIN32")(nl)
(out "#if (_MSC_VER <= 1300)")(nl)
(out "inline float fmod(float a1, float a2) { return fmodf(a1, a2); }")(nl)
(out "#endif")(nl)
(out "#else")(nl)
(out "inline float fmod(float a1, float a2) { return fmodf(a1, a2); }")(nl)
(out "#endif")(nl)
(nl)
(out "inline bool is_zero(int x) { return x == 0; }")(nl)
(out "inline bool is_zero(decimal x) { return x.is_zero(); }")(nl)
;(out "inline bool is_zero(float x) { return (x >= 0 ? x : -x) < DOUBLE_ZERO; }")(nl)
;(out "inline bool is_zero(double x) { return (x >= 0 ? x : -x) < DOUBLE_ZERO; }")(nl)
(nl)
(nl)
(out "decimal xs_integer2xs_decimal(const tuple_cell &tc) { return decimal(tc.get_xs_integer()); }")(nl)
...
(out "float xs_decimal2xs_float(const tuple_cell &tc) { return tc.get_xs_decimal().to_float(); }")(nl)
(out "double xs_decimal2xs_double(const tuple_cell &tc) { return tc.get_xs_decimal().to_double(); }")(nl)
(out "double xs_float2xs_double(const tuple_cell &tc) { return (double)(tc.get_xs_float()); }")(nl)
(out "double xdt_untypedAtomic2xs_double(const tuple_cell &tc) { return cast_to_xs_double(tc).get_xs_double(); }")(nl)
(nl)
(nl)
(generate-numeric-funs generate-numeric-fun-body op-lst type-lst)
(nl)
(generate-numeric-funs generate-numeric-fun-e-body op-lst type-lst)
(nl)
(out "tuple_cell op_numeric_unary_plus(const tuple_cell &a)")(nl)
(out "{")(nl)
(out "    if (!a.is_atomic())")(nl)
(out "        throw USER_EXCEPTION2(SE1003, \"Numerical operations are defined on atomic values only\");")(nl)
(out "    switch (a.get_atomic_type())")(nl)
(out "    {")(nl)
(out "        case xdt_untypedAtomic: return op_numeric_unary_plus_xdt_untypedAtomic(a);")(nl)
(out "        case xs_integer       : return op_numeric_unary_plus_xs_integer(a);")(nl)
(out "        case xs_decimal       : return op_numeric_unary_plus_xs_decimal(a);")(nl)
(out "        case xs_float         : return op_numeric_unary_plus_xs_float(a);")(nl)
(out "        case xs_double        : return op_numeric_unary_plus_xs_double(a);")(nl)
(out "        default               : throw USER_EXCEPTION2(XP0006, \"Invalid arguments of a numeric operation\");")(nl)
(out "    }")(nl)
(out "}")(nl)
(nl)
(out "tuple_cell op_numeric_unary_minus(const tuple_cell &a)")(nl)
...
(out "    switch (a.get_atomic_type())")(nl)
(out "    {")(nl)
(out "        case xdt_untypedAtomic: return op_numeric_unary_minus_xdt_untypedAtomic(a);")(nl)
(out "        case xs_integer       : return op_numeric_unary_minus_xs_integer(a);")(nl)
(out "        case xs_decimal       : return op_numeric_unary_minus_xs_decimal(a);")(nl)
(out "        case xs_float         : return op_numeric_unary_minus_xs_float(a);")(nl)
(out "        case xs_double        : return op_numeric_unary_minus_xs_double(a);")(nl)
(out "        default               : throw USER_EXCEPTION2(XP0006, \"Invalid arguments of a numeric operation\");")(nl)
(out "    }")(nl)
(out "}")(nl)
(nl)
(out "tuple_cell op_numeric_unary_plus_e(const tuple_cell &a)")(nl)
(out "{")(nl)
(out "    if (a.is_eos()) return tuple_cell::eos();")(nl)
(out "    return op_numeric_unary_plus(a);")(nl)
(out "}")(nl)
(nl)
(out "tuple_cell op_numeric_unary_minus_e(const tuple_cell &a)")(nl)
(out "{")(nl)
(out "    if (a.is_eos()) return tuple_cell::eos();")(nl)
(out "    return op_numeric_unary_minus(a);")(nl)
(out "}")(nl)
(nl)
...
(out "tuple_cell op_numeric_unary_plus_xdt_untypedAtomic(const tuple_cell& a) { return cast_to_xs_double(a); }")(nl)
(nl)
(out "tuple_cell op_numeric_unary_minus_xs_integer(const tuple_cell& a)")(nl)
...
(out "tuple_cell op_numeric_unary_minus_xdt_untypedAtomic(const tuple_cell& a)")(nl)
(out "{ return tuple_cell::atomic(-cast_to_xs_double(a).get_xs_double()); }")(nl)
(nl)
(if output-to-file (close-output-port port))
