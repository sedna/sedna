  ...
  (let* ((gct (find-gct word type1 type2)))
    ...
    (cond ((string=? word "integer_divide")
          ...
          ((string=? word "divide")
           (begin
             (out "    ")
             (if (eq? gct 'xs_integer) (out "xs_decimal_t") (out-XMLSchema-type-as-C-type gct))
             (out " a2_val = ")
...
(nl)
(out "inline __int64 fmod(__int64 a1, __int64 a2) { return a1 % a2; }")(nl)
...
(out "#endif")(nl)
(nl)
(out "inline bool is_zero(__int64 x) { return x == (__int64)0; }")(nl)
(out "inline bool is_zero(xs_decimal_t x) { return x.is_zero(); }")(nl)
