...
(out "double xs_untypedAtomic2xs_double(const tuple_cell &tc) { return cast_to_xs_double(tc).get_xs_double(); }")(nl)
(nl)
(nl)
(nl)
...
(out "tuple_cell op_numeric_unary_plus_xs_untypedAtomic(const tuple_cell& a) { return cast_to_xs_double(a); }")(nl)
(nl)
(out "tuple_cell op_numeric_unary_minus_xs_integer(const tuple_cell& a)")(nl)
