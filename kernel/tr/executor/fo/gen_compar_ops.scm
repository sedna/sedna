...
(define table
  '((value_comp_eq
    ...
    (value_comp_ne
     ...
     (xs_date           (xs_date)   xs_date_not_equal)
    ...
    (value_comp_lt
     ...
     (xs_date           (xs_date)   xs_date_less_than)
    ...
    (value_comp_le
     ...
     (xs_date           (xs_date)   xs_date_less_equal)
    ...
    (value_comp_gt
     ...
     (xs_date           (xs_date)   xs_date_greater_than)
    ...
    (value_comp_ge
     ...
     (xs_date           (xs_date)   xs_date_greater_equal)
                  ...
                  (begin
                    ...
                    (cond ((string=? (substring (symbol->string (caddar outer)) 0 10) "op_numeric")
                          ...
                          ((string=? (substring (symbol->string (caddar outer)) 0 7) "xs_date")
                           (out "(a1.get_xs_date(), a2.get_xs_date());"))
