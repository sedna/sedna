...
(define table
  '((value_comp_eq
     ...
     (xs_string         (xs_string xdt_untypedAtomic) fn_compare_equal)
     (xdt_untypedAtomic (xs_string xdt_untypedAtomic) fn_compare_equal)
     (xdt_yearMonthDuration (xdt_yearMonthDuration) xs_dateTime_equal)
     (xdt_dayTimeDuration (xdt_dayTimeDuration) xs_dateTime_equal)
    ...
    (value_comp_ne
     ...
     (xs_string         (xs_string xdt_untypedAtomic) fn_compare_not_equal)
     (xdt_untypedAtomic (xs_string xdt_untypedAtomic) fn_compare_not_equal)
     (xdt_yearMonthDuration (xdt_yearMonthDuration) xs_dateTime_not_equal)
     (xdt_dayTimeDuration (xdt_dayTimeDuration) xs_dateTime_not_equal)
    ...
    (value_comp_lt
     ...
     (xs_string         (xs_string xdt_untypedAtomic) fn_compare_less_than)
     (xdt_untypedAtomic (xs_string xdt_untypedAtomic) fn_compare_less_than)
     (xdt_yearMonthDuration (xdt_yearMonthDuration) xs_dateTime_less_than)
     (xdt_dayTimeDuration (xdt_dayTimeDuration) xs_dateTime_less_than)
    ...
    (value_comp_le
     ...
     (xs_string         (xs_string xdt_untypedAtomic) fn_compare_less_equal)
     (xdt_untypedAtomic (xs_string xdt_untypedAtomic) fn_compare_less_equal)
     (xdt_yearMonthDuration (xdt_yearMonthDuration) xs_dateTime_less_equal)
     (xdt_dayTimeDuration (xdt_dayTimeDuration) xs_dateTime_less_equal)
    ...
    (value_comp_gt
     ...
     (xs_string         (xs_string xdt_untypedAtomic) fn_compare_greater_than)
     (xdt_untypedAtomic (xs_string xdt_untypedAtomic) fn_compare_greater_than)
     (xdt_yearMonthDuration (xdt_yearMonthDuration) xs_dateTime_greater_than)
     (xdt_dayTimeDuration (xdt_dayTimeDuration) xs_dateTime_greater_than)
    ...
    (value_comp_ge
     ...
     (xs_string         (xs_string xdt_untypedAtomic) fn_compare_greater_equal)
     (xdt_untypedAtomic (xs_string xdt_untypedAtomic) fn_compare_greater_equal)
     (xdt_yearMonthDuration (xdt_yearMonthDuration) xs_dateTime_greater_equal)
     (xdt_dayTimeDuration (xdt_dayTimeDuration) xs_dateTime_greater_equal)
                  ...
                  (begin
                    ...
                    (cond ((string=? (substring (symbol->string (caddar outer)) 0 10) "op_numeric")
                          ...
                          ((string=? (substring (symbol->string (caddar outer)) 0 10) "fn_compare")
                           (out "(")
                           (if (eq? (caar outer) 'xdt_untypedAtomic)
                               (out "cast_to_xs_string(a1)")
                               (out "a1"))
                           (out ", ")
                           (if (eq? (car inner) 'xdt_untypedAtomic)
                    ...
                    (nl)
                    (loop2 (cdr inner)))))
            (out "            default: throw USER_EXCEPTION2(XP0006, \"Type incompatibility in value comparison\");")(nl)
            (out "            }")(nl)
            (loop1 (cdr outer)))))
    (out "    default: throw USER_EXCEPTION2(XP0006, \"Type incompatibility in value comparison\");")
    (nl)
    (out "    }")
    (nl)
...
(out "        throw USER_EXCEPTION2(XP0006, \"Can not perform node and order comparison on none-nodes\");")(nl)
