...
PPAxisChild::PPAxisChild(variable_context *_cxt_, 
                         PPOpIn _child_,
...
PPIterator* PPAxisChild::copy(variable_context *_cxt_)
{
...
bool PPAxisChild::result(PPIterator* cur, variable_context *cxt, void*& r)
{
    PPOpIn child;
